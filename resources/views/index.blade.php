...
<div class="row mt-5">
    <div class="col-1 border-right border-dark align-items-start d-none d-xs-none d-sm-none d-md-flex d-lg-flex d-xl-flex" style="min-height: 18em; min-width: 7em">
        <h3 class="h3 text-uppercase font-weight-bold" style="transform: rotate(270deg) translateX(-5em)">{{ __('app.categories') }}</h3>   
    </div>
...
<div class="row mt-5">
    <div class="col-1 border-right border-dark align-items-start d-none d-xs-none d-sm-none d-md-flex d-lg-flex d-xl-flex" style="min-height: 18em; min-width: 7em">
        <h3 class="h3 text-uppercase font-weight-bold ml-4" style="transform: rotate(270deg) translateX(-3em);">{{ __('app.actions') }}</h3>   
    </div>
